...
dat$Region <- recode(dat$Region, "Middle East" = "Southwest Asia")

dat <- subset(dat, Region == "Southwest Asia")

# ── Color scale ────────────────────────────────────────────────
region_colors <- c("Southwest Asia" = "darkgoldenrod1")
...
ggsave("May17_2026_SouthwestAsia_panel.pdf",
